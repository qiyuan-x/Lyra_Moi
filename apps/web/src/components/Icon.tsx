...
const paths: Record<IconName, React.ReactNode> = {
  ...
  pose: <><circle cx="12" cy="4.5" r="2.2"/><path d="M12 7v6M7 9.5l5 2 5-2M12 13l-3.5 7M12 13l3.5 7"/><circle cx="7" cy="9.5" r="1"/><circle cx="17" cy="9.5" r="1"/></>,
  ...
  hide: <><path d="M3 12s3.5-6 9-6 9 6 9 6-3.5 6-9 6-9-6-9-6z"/><circle cx="12" cy="12" r="2.5"/><path d="m4 4 16 16"/></>,
